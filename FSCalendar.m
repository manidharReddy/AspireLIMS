...
- (void)initialize
{
    ...
    contentView.backgroundColor = [UIColor colorWithRed:30.0/255.0 green:144.0/255.0 blue:255.0/255.0 alpha:1];
  ...
  //  self.backgroundColor = [UIColor whiteColor];
    ...
    daysContainer.backgroundColor = [UIColor whiteColor];
    //daysContainer.layer.borderColor=[UIColor blueColor].CGColor;
    //daysContainer.layer.borderWidth = 2;
